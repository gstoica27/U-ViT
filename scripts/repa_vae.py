...
import numpy as np
import torch
from scripts.torch_utils import persistence
from scripts.torch_utils import misc
...
def load_stability_vae(vae_name='stabilityai/sd-vae-ft-mse', device=torch.device('cpu')):
    # sys.path.insert(0, "/weka/prior-default/georges/research/stylegan3")
    import scripts.dnnlib as dnnlib
